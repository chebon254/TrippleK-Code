        ...
        <div class="space-y-4">
          <div>
            ...
            <div class="relative">
              ...
              <input type="number" name="price_per_day" required min="0" step="1"
          ...
          <div>
            ...
            <div class="relative">
              <span class="absolute left-3 top-1/2 -translate-y-1/2 text-xs text-gray-400">USD</span>
              <input type="number" name="price_airport" min="0" step="1"
          ...
          <div>
            ...
            <div class="relative">
              <span class="absolute left-3 top-1/2 -translate-y-1/2 text-xs text-gray-400">USD</span>
              <input type="number" name="price_wedding" min="0" step="1"
