...
<div class="mb-6 flex items-center justify-between">
  <div>
    <h1 class="text-dark-1 mb-2 text-3xl font-semibold">Edit Car</h1>
    <p class="text-light-1"><?= h($car['make'] . ' ' . $car['model'] . ' — ' . $car['registration_number']) ?></p>
  </div>
  <a href="/admin/cars.php" class="rounded border border-gray-200 px-4 py-2 text-sm text-gray-600 hover:bg-gray-50">&larr; Back</a>
</div>
...
<form method="POST" action="/admin/edit-car.php?id=<?= $car_id ?>" enctype="multipart/form-data"
  ...
  <div class="grid gap-6 lg:grid-cols-3">
    <div class="lg:col-span-2 space-y-6">
      ...
      <div class="rounded bg-white p-6 shadow-[0_10px_30px_0_#05103608]">
        ...
        <div class="grid gap-4 sm:grid-cols-2">
          ...
          <div>
            ...
            <select name="category_id" required class="border-border focus:border-dark-1 w-full rounded border px-3 py-2.5 text-sm outline-none">
        ...
        <div class="mt-4">
          ...
          <textarea name="description" rows="4" class="border-border focus:border-dark-1 w-full rounded border px-3 py-2.5 text-sm outline-none resize-none"><?= h($car['description'] ?? '') ?></textarea>
        </div>
      </div>
      ...
      <?php if (!empty($images)): ?>
      <div class="rounded bg-white p-6 shadow-[0_10px_30px_0_#05103608]">
        <h2 class="mb-4 text-base font-medium text-dark-1">Current Photos</h2>
      ...
      <!-- Add More Images -->
      <div class="rounded bg-white p-6 shadow-[0_10px_30px_0_#05103608]">
        <h2 class="mb-4 text-base font-medium text-dark-1">Add More Photos</h2>
    ...
    <div class="space-y-6">
      <div class="rounded bg-white p-6 shadow-[0_10px_30px_0_#05103608]">
        ...
        <div class="space-y-4">
          ...
          <div>
            <label class="mb-1.5 block text-sm font-medium text-dark-1"><?= $l ?></label>
            <div class="relative">
      ...
      <div class="rounded bg-white p-6 shadow-[0_10px_30px_0_#05103608]">
        <h2 class="mb-4 text-base font-medium text-dark-1">Options</h2>
      ...
      <div class="rounded bg-white p-6 shadow-[0_10px_30px_0_#05103608] space-y-3">
        <button type="submit"
        ...
        <a href="/admin/cars.php"
          class="block w-full rounded border border-gray-200 px-6 py-3 text-center text-sm text-gray-600 hover:bg-gray-50">
          Cancel
        </a>
      </div>
    </div>
