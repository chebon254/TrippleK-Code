...
<main class="flex-grow">
  ...
  <section class="relative z-20 pt-35 md:pt-50">
    <div class="bg-yellow-1 absolute top-0 left-0 -z-10 h-full w-full"></div>

    <div class="container mx-auto h-full px-4">
      <div class="mb-6 flex flex-col items-center justify-center text-center" data-aos="fade-up" data-aos-delay="0">
        <h1 class="md:text-60 text-dark-1 text-3xl leading-tight font-semibold sm:text-4xl">
          <?= h(get_setting('company_tagline', 'Affordable Car Hire in Kenya')) ?>
        </h1>
        <p class="text-dark-1 mt-3">
          Self-drive, airport transfers, chauffeur &amp; wedding packages across Kenya.
        </p>
      </div>

      <!-- Search form -->
      <div class="relative z-20 mx-auto w-full max-w-[900px] rounded bg-white shadow-[0_20px_40px_0_rgba(5,16,54,0.07)] lg:p-5"
        x-data="{
          location: '',
          dateFrom: '',
          dateTo: '',
        ...
        <div class="flex w-full items-center max-lg:flex-col lg:gap-7.5" data-aos="fade-up" data-aos-delay="0">
          <div class="grid w-full lg:grid-cols-3 lg:gap-7.5">
            ...
            <div class="relative max-lg:p-5 lg:pl-6.5">
              <span class="text-15 text-dark-1 block font-medium">Pickup Location</span>
              <input type="text" placeholder="City or Airport" x-model="location"
                class="outline-none w-full text-light-1 placeholder-light-1" />
            </div>

            <!-- Dates -->
            <div class="relative border-[#DADFE6] max-lg:border-y max-lg:p-5 lg:border-x lg:px-7.5">
              <span class="text-15 text-dark-1 block font-medium">Pickup Date</span>
            ...
            <div class="relative max-lg:p-5">
              <span class="text-15 text-dark-1 block font-medium">Return Date</span>
          ...
          <div class="max-lg:w-full max-lg:px-5 max-lg:pb-5">
            <button type="button" @click="doSearch()"
              class="bg-blue-1 hover:bg-blue-2 text-white flex h-12 items-center gap-2 rounded px-8 text-sm font-medium whitespace-nowrap transition-colors lg:h-14 lg:text-base">
    ...
    <div x-data="hero8()" x-init="init()" class="relative z-10 -mt-12.5 px-6">
      <div class="absolute bottom-0 left-1/2 -z-10 h-1/2 w-dvw -translate-x-1/2 bg-white"></div>
      <div class="swiper relative mx-auto max-w-[1500px]" x-ref="masthead" data-aos="fade-up" data-aos-delay="100">
        ...
        <div>
          <button class="slider-prev hover:text-dark-2 absolute top-1/2 left-3 z-20 flex size-12.5 -translate-y-1/2 cursor-pointer items-center justify-center rounded-full border border-white font-bold text-white duration-300 hover:bg-white">
            <span class="icon-arrow-left text-sm"></span>
          </button>
          <button class="slider-next hover:text-dark-2 absolute top-1/2 right-3 z-20 flex size-12.5 -translate-y-1/2 cursor-pointer items-center justify-center rounded-full border border-white font-bold text-white duration-300 hover:bg-white">
  ...
  <section class="pt-20 md:pt-30">
    <div class="container">
      <div class="mb-10 text-center">
        <h2 class="text-dark-1 text-3xl font-semibold">Popular Car Hire</h2>
      ...
      <div class="relative" x-data="carsCarousel8()" data-aos="fade-left">
        ...
        <div>
          <button x-ref="prev"
            class="slider-prev hover:text-dark-2 absolute top-1/3 -left-5 z-20 flex size-12.5 -translate-y-1/2 cursor-pointer items-center justify-center rounded-full border border-gray-200 font-bold text-dark-1 duration-300 hover:bg-white shadow">
            <span class="icon-chevron-left text-sm"></span>
          </button>
          <button x-ref="next"
            class="slider-next hover:text-dark-2 absolute top-1/3 -right-5 z-20 flex size-12.5 -translate-y-1/2 cursor-pointer items-center justify-center rounded-full border border-gray-200 font-bold text-dark-1 duration-300 hover:bg-white shadow">
      ...
      <div class="mt-10 text-center">
        <a href="/cars.php"
          class="text-dark-1 border-dark-1 hover:bg-dark-1 hover:text-white inline-flex h-12 items-center rounded border px-8 text-sm font-medium transition-colors">
          See All Cars
        </a>
      </div>
    </div>
  ...
  <section id="services" class="pt-20 md:pt-30">
    <div class="container">
      <div class="mb-10 text-center">
        <h2 class="text-dark-1 text-3xl font-semibold">Our Services</h2>
      ...
      <div class="xs:grid-cols-2 grid gap-7.5 md:grid-cols-4">
        ...
        <a href="<?= $svc['link'] ?>" id="<?= $svc['id'] ?>"
          class="rounded border border-border bg-white p-6 text-center transition-shadow hover:shadow-xl"
          ...
          <h3 class="text-dark-1 mb-2 text-base font-medium"><?= $svc['title'] ?></h3>
  ...
  <section class="pt-20 md:pt-30">
    <div class="container">
      <div class="mb-10 text-center">
        <h2 class="text-dark-1 text-3xl font-semibold">Browse by Category</h2>
      </div>
      <div class="xs:grid-cols-2 grid gap-7.5 md:grid-cols-4">
    ...
    <div class="container">
      <div class="row y-gap-40 items-center xl:gap-20">
        <div class="col-xl-5" data-aos="fade-right">
          <h2 class="text-dark-1 mb-6 text-3xl font-semibold">Booking Requirements</h2>
          <ul class="space-y-4">
            <?php
            $reqs = [
            ...
            <li class="flex items-start gap-3">
              ...
              <span class="text-dark-1"><?= h($r) ?></span>
            </li>
            <?php endforeach; ?>
          </ul>
          <div class="mt-8 flex flex-wrap gap-4">
            <a href="/cars.php"
              class="bg-blue-1 hover:bg-blue-2 rounded px-6 py-3 text-sm font-medium text-white transition-colors">
              Book a Car
            </a>
            <?php if ($company_wa): ?>
            <a href="https://wa.me/<?= h(preg_replace('/[^0-9]/', '', $company_wa)) ?>?text=Hello%2C+I%27d+like+to+enquire+about+a+booking."
              target="_blank" rel="noopener"
              class="flex items-center gap-2 rounded border border-green-500 px-6 py-3 text-sm font-medium text-green-600 hover:bg-green-50 transition-colors">
  ...
  <section class="pt-20 md:pt-30 pb-20 md:pb-30">
    <div class="container">
      <div class="bg-blue-1 relative overflow-hidden rounded-2xl p-12 text-center text-white">
        ...
        <a href="/cars.php"
          class="inline-block rounded bg-white px-8 py-3.5 text-sm font-semibold text-blue-1 hover:bg-yellow-1 transition-colors">
          Browse All Cars
        </a>
      </div>
    </div>
