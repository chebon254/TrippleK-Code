...
<style>
  ...
  #wa-float .wa-label{max-width:0;opacity:0;overflow:hidden;white-space:nowrap;transition:max-width .3s ease,opacity .3s ease,margin .3s ease}
  #wa-float:hover .wa-label{max-width:140px;opacity:1;margin-right:.6rem}
</style>
<a id="wa-float"
  href="https://wa.me/<?= h(preg_replace('/[^0-9]/', '', $company_wa)) ?>?text=Hello+<?= urlencode($company_name) ?>%2C+I%27d+like+to+enquire+about+a+car+hire."
  target="_blank" rel="noopener" aria-label="Chat on WhatsApp"
  style="position:fixed;bottom:1.5rem;right:1.5rem;z-index:9999;display:flex;align-items:center;justify-content:center;background:#25d366;border-radius:9999px;padding:.85rem 1rem;color:#fff;text-decoration:none;box-shadow:0 4px 16px rgba(0,0,0,.35)">
  <span class="wa-label" style="font-size:.875rem;font-weight:600;color:#fff">Chat with us</span>
  <svg style="width:1.75rem;height:1.75rem;fill:currentColor;flex-shrink:0" viewBox="0 0 24 24">
